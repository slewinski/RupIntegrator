...
namespace ConsImport
{
    public class ConsImportFromDB
    {
        ...
        public List<ConsImportData> GetDataFromDB(ConsExternalDBConnectionConfig knf, DateTime odDnia, DateTime doDnia)
        {
            ...
            return lMock;
#endif
            log.Debug("uruchamianie procedury składowaniej " +knf.sp_name + " z parametrami " + odDnia.ToString() + ", " + doDnia.ToString());
            ...
            if (dset != null)
            {
                log.Debug("Pobrano dane z bazy danych przy użyciu liczba wierszy " + dset.Tables[0].Rows.Count + " " + knf.sp_name + " dla przedziału " + odDnia.ToString() + " do " + doDnia.ToString());
        ...
        private List<ConsImportData> ProceedDataTable(DataSet ds)
        {
            ...
            try
            {
                ...
                */
                ...
                using (RupDBEntities context = new RupDBEntities())
                {
                    ...
                    {
                        log.Debug("Dla kolejnych grup id sprawty, id_strony ");
                        DataRow row = group.First();

                        int idSprawy = group.Key.IdSprawy;
                        int idStrony = group.Key.IdStrony;

                        log.Debug("Dla kolejnych grup id sprawy "+ idSprawy.ToString() + ", id_strony " + idStrony.ToString());
                        ...
                        {
                            log.Debug(" Nie ma orzeczeń do importu ");
                        }
                        ...
                        string zalacznikZawartosc = S(row, "ZalacznikZawartosc");
                            ...
                            if (orzeczenieRow != null)
                            {
                                ...
                                log.Debug("Brak orzeczeń do importu");


                        log.Debug("Sprawdzenie czy już taka karta była - kolumna ststus - tabela ConsKartaTransfer");
                        ...
                        if (skip)
                        {
                            log.Debug("Była już taka karta, pomijam ją ");
                            continue;
                        }
                      ...
                      new DokumentTozsamosci
                      {
                        ...
                        log.Debug("tworzenie requestu  dla idSprawy=" + idSprawy + ", idStrony=" + idStrony);
                    ...
                    .ToArray(),
                      ...
                      new Adres
                      {
                        ...
                        */
                        ...
                        log.Debug("wygenrowano request dla idSprawy=" + idSprawy + ", idStrony=" + idStrony);
            ...
            {
                log.Error("Błąd przetwarzania danych na XML komunikatu " , ex);
                return null;
            }
        }
